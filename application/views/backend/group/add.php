<form class="form-horizontal form-bordered validate" action="<?php echo site_url('panel/groups/add_save'); ?>" role="form" method="POST">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="group_name" data-rule-required="true">
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-2 control-label">Deskripsi: <span class="mandatory">*</span></label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="group_description" data-rule-required="true">
        </div>
      </div>
